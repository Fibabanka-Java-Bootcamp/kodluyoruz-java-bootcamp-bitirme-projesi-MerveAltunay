...
public class CreditCardService {
    ...
    public ResponseEntity<Object> withDrawCreditCard(BalanceTransactionRequest balanceTransactionRequest) throws IOException {
        ...
        if(creditCard != null){
            ...
            if(amount < creditCard.getRemainingCreditLimit()){
                ...
                CardStatement cardStatement = new CardStatement(0L,balanceTransactionRequest.getCardNumber(),new Timestamp(System.currentTimeMillis()),"Withdraw Balance","CreditCard");
